...
export const Z_TYPE = z.string().describe(`The type of question, valid types are: MultipleChoice, FillInTheBlank, SelectAllThatApply, ShortAnswer, Matching, Ordering, Image.
...
export const Z_ANSWER = z.string().describe(`The answer to the question, must be one of the options if the question is a MultipleChoice question.
